...
local themeStyles = {
    ...
    LightTheme = {
        ...
        Background = Color3.fromRGB(0,255,0),
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "Serpent" then
        ...
        elseif themeList.TextColor == nil then
            themeList.TextColor = Color3.fromRGB(0,255,0)
    ...
    tabFrames.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
    ...
    pages.Name = "pages"
    pages.Parent = Main
    pages.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
    ...
    infoContainer.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
    ...
    function Tabs:NewTab(tabName)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in next, tabFrames:GetChildren() do
                if v:IsA("TextButton") then
                    if themeList.SchemeColor == Color3.fromRGB(0,255,0) then
                        Utility:TweenObject(v, {TextColor3 = Color3.fromRGB(0,255,0)}, 0.2)
                    end 
            ...
            if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                Utility:TweenObject(tabButton, {TextColor3 = Color3.fromRGB(0,255,0)}, 0.2)
            end 
		...
		sectionHead.Visible = true
            ...
            sectionName.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                Utility:TweenObject(sectionName, {TextColor3 = Color3.fromRGB(0,255,0)}, 0.2)
            end 
               
            sectionInners.Name = "sectionInners"
            sectionInners.Parent = sectionFrame
            sectionInners.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                Sample.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                touch.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                btnInfo.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
                    Utility:TweenObject(moreInfo, {TextColor3 = Color3.fromRGB(0,255,0)}, 0.2)
                end 
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                write.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                togName.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                moreInfo.RichText = true
                moreInfo.Text = "  "..tTip
                moreInfo.TextColor3 = Color3.fromRGB(0, 255, 0)
                moreInfo.TextSize = 14.000
                moreInfo.TextXAlignment = Enum.TextXAlignment.Left
                ...
                function Elements:NewToggle(tname, nTip, callback)
                    ...
                    toggleEnabled.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                val.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            function Elements:NewDropdown(dropname, dropinf, list, callback)
                ...
                listImg.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                itemTextbox.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                for i,v in next, list do
                    ...
                    Sample1.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                function DropFunction:Refresh(newList)
                    ...
                    for i,v in next, newList do
                        ...
                        Sample11.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                togName_2.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            function Elements:NewColorPicker(colText, colInf, defcolor, callback)
                ...
                rgb.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                rbgcircle.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                darkness.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                darkcircle.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
                ...
                onrainbow.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
            ...
            function Elements:NewLabel(title)
	            ...
	            if themeList.SchemeColor == Color3.fromRGB(0,0,0) then
	                Utility:TweenObject(label, {TextColor3 = Color3.fromRGB(0,255,0)}, 0.2)
	            end 
